--Updated script for re-review with added Physics of platforms falling on touch and fading out :)

local Players = game:GetService("Players") -- used for iterating survivors and teleporting each round
